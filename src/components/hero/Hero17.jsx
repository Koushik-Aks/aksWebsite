          ...
          <div className="col-xl-7">
            <div className="home17-hero-content">
              <h1 className="banner-title animate-up-1 mb25">
               AKS IT SERVICES <br className="d-none d-xl-block" />
             ...
             AUDITING   |   CONSULTING  |   COMPLIANCE  |   FORENSICS  |   TRAINING
              ...
              <p className="text-white text animate-up-2">
              Providing a secure cyber world for a better,
              peaceful and  <br className="d-none d-lg-block" />
              progressive environment for mankind.
              </p>
