            ...
            <div className="col-6 col-md-3">
              <div className="funfact_one mb20-sm text-center">
                <div className="details">
                  ...
                  <p className="text mb-0">Years of empanelment with CERT-IN</p>
                </div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="funfact_one mb20-sm text-center">
                <div className="details">
                  ...
                  <p className="text mb-0">Number of application Audited</p>
                </div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="funfact_one mb20-sm text-center">
                <div className="details">
                  ...
                  <p className="text mb-0">Number of clients</p>
                </div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="funfact_one mb20-sm text-center">
                <div className="details">
                  ...
                  <p className="text mb-0">Certified Professionals</p>
                </div>
              </div>
            </div>
          </div>
